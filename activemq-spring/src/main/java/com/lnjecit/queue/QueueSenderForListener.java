...
/**
 * @author lnj
 * @description 点对点模式 消息发送方（使用消息监听器接收消息）
 * @date 2019-01-04 10:16
 **/
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {"classpath:spring-activemq-queue-consumer-with-listener.xml"})
public class QueueSenderForListener {
